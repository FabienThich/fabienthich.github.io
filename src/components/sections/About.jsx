        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          <div className="p-6 rounded-xl border-white/20 border hover:-translate-y-1 transition-all">
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-2">
              <li>
                <b>BSc in Data Science</b> (Healthcare Stream) - York University
              </li>
              <li>
                Relevant Coursework:
                <ul className="ml-12">
          ...
          <div className="p-6 rounded-xl border-white/20 border hover:-translate-y-1 transition-all">
            ...
            <div className="space-y-4 text-gray-300">
              <div>
                ...
                <p>
                  Played a key role in managing daily operations while tutoring
                  students from Grades 1–12, including those with ADHD and other
                  support needs, through one-on-one, small group, and large
                  group sessions.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  with 3 clients, building features and end-to-end products, and
                  improved website performance (cut image load times from 800ms
                  to 0ms).
                </p>
              </div>
            </div>
